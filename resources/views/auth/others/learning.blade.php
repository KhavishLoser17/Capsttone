...
<div class="col-span-1 mb-2">
    <form>
        ...
        <div class="relative flex">
            ...
            <a href="{{ url('learning_add') }}" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-4 ml-2 dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-800 text-center">
                ADD LMS
            </a>
            @endif
        </div>
